import { Activity, Command, Plus, ServerCog, Square, Target, Workflow } from 'lucide-react'
...
export function AppHeader({ health, healthError, uiStatus, taskId, taskMode, verification, canStop, onStop, onNew }: AppHeaderProps) {
